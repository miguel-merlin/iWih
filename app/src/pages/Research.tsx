    ...
    <div id="Underrepresentation-info">
        <div id="top-statistic">
            ...
            <h2 id="underrepresentation-statistic">
                ...
                <span className="red">34%</span> of participants in Phase I drug testing.
            </h2>
        </div>
        <section id="problem">
            <div id="problem-container">
                <div id="problem-text">
                    ...
                    <hr id="problem-line"/>
                    <p className="problem-p">Women are consistently under-represented in 
                        medical research, which becomes an issue when results of male-dominated 
                        testing are generalized, ignoring important biological sex differences.</p>
                    <p className="problem-p">
                        Particularly with clinical drug testing, males and females exhibit differences in pharmacokinetics, or
                        the way their bodies absorb, distribute, metabolize, and excrete drugs.
                        <a id="problem-link" href="https://bsd.biomedcentral.com/articles/10.1186/s13293-020-00308-5" target="_blank">96% of drugs that cause elevated 
                            pharmacokinetics in women</a> are more likely to cause of adverse drug reactions (ADRs) in women than men,
                        and women experience ADRs twice as often as men. Yet, current practice is to prescribe similar doses 
                        regardless of sex, based on the results of biased research studies.
                    </p>
                </div>
                <img src={trial}></img>
            </div>
            ...
            <div className="container px-4 py-5 causes-container" id="featured-3">
                ...
                <div className="feature col">
                    ...
                    <p className="cause-p">Women who participate in clinical trials have reported 
                        ...
                        radically outnumber women. There have been cases where male convicted rapists
                        and felons have been allowed to participate, staying in rooms unseparated
                        from women.
                    </p>
                    <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7050919/" target="_blank" className="icon-link">
                    See reference
                    <svg className="bi"><use xlinkHref="#chevron-right"></use></svg>
                    </a>
                </div>
                <div className="feature col">
                    ...
                    <p className="cause-p">Due to existing stigmas, men may discourage their 
                        ...
                        otherwise pressure them to leave. Researchers spoke to one woman named Penny, who said
                        that her husband explicitly told her to stop enrolling in trials.
                    </p>
                    <a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7050919/" target="_blank" className="icon-link">
                    See reference
                    <svg className="bi"><use xlinkHref="#chevron-right"></use></svg>
